...
fn get_size_of_constants() -> usize {return 3;}
...
Fr_mul!(expaux[0],ctx.signalValues[mySignalStart + 1],ctx.circuitConstants[0]); // line circom 7
...
fn main() {
    ...
    circuitConstants[0] = F::from(2);
circuitConstants[1] = F::from(5);
circuitConstants[2] = F::from(0);
